...
module.exports = function(ss, middleware) {
  ...
  var model = function model(des, chan) {
    ...
    //allow middleware
    des.use = function use(nameOrModule) {
      try {
    ...
    var exec = function exec(req, res, i) {
      if(i == undefined) {
        i = 0;
      }
...
var getBranchFromTree = function getBranchFromTree(tree,stringMethod,module) {
  if(module) {
