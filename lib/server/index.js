            ...
            try {
              ...
              var updateModel = function() {
                ...
                model(req, function(err, modelObj) {
                  ...
                  var logObj = {timeStamp:Date.now(),socket:req.socketId,model:req.modelName,params:req.params,elapsed:elapsed};
                  ss.publish.channel('admin', 'modelTime', logObj);
...
var stopPolling = function(clientId,model) {
  ...
  var timeoutId = client[model].timeoutId;
  if(timeoutId) {
    clearTimeout(timeoutId);
  }
