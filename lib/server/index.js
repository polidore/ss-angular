...
module.exports = function(responderId, config, ss) {
  ...
  ss.client.send('mod', 'synced-model', loadFile('model.js'));
    ...
    interfaces: function(middleware) {
      return {
        websocket: function(msg, meta, send) {
          ...
          ss.log('->'.cyan, "SSAngular invoked: ".red,msg,JSON.stringify(models));
...
var loadFile = function(name) {
  console.log("->".red, "Readfile shouldn't be called much".red);
