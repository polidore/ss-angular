...
This library does expose a raw ss API called @linkModel@.  You just pass it the model name and it passes you back an object every N seconds.  From the ss-angular client library:
