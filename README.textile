...
It's that simple.  You define your app's module, the ssAngular dependency and then inject syncModel into your controller's dependencies.  In this case, examlple is the name of the file I created in @server/model@ and it will be the name of the model on angular's $scope. Here's the html that uses this controller:
